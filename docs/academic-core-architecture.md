...
| Certificate Engine | ✔ | ◑ | ◑ | ✘ | design frozen v1.0 ([ADR-002](./adr/ADR-002-certificate-engine-architecture.md)); **Phases 0–1 done** — foundation contracts + full data model (7 models + counter, filtered unique indexes, transcript pinned by pointer), 50 tests; no repositories/eligibility/commands/UI yet |
