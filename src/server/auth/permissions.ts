...
export const PERMISSIONS = {
  ...
  // Class Schedules
  CLASS_SCHEDULES_VIEW: "class_schedules.view",
  CLASS_SCHEDULES_CREATE: "class_schedules.create",
  CLASS_SCHEDULES_UPDATE: "class_schedules.update",
  CLASS_SCHEDULES_DELETE: "class_schedules.delete",
...
export const ROLE_PERMISSIONS: Record<SystemRole, Permission[]> = {
  ...
  SECRETARY: [
    ...
    PERMISSIONS.CLASS_SCHEDULES_VIEW,
    PERMISSIONS.CLASS_SCHEDULES_CREATE,
    PERMISSIONS.CLASS_SCHEDULES_UPDATE,
