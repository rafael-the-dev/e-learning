...
// FinancialAuditEventType — typed domain events written to financial_audit_logs
export const FinancialAuditEventType = {
  // Invoice
  INVOICE_CREATED:             "INVOICE_CREATED",
  ...
  RECEIPT_PARTIALLY_REFUNDED:  "RECEIPT_PARTIALLY_REFUNDED",
  // Installment
  INSTALLMENT_RECALCULATED:    "INSTALLMENT_RECALCULATED",
  // Allocation
  ...
  WALLET_OVERPAYMENT_CREDITED: "WALLET_OVERPAYMENT_CREDITED",
  ...
  // Financial Integrity
  INTEGRITY_ISSUE_DETECTED:    "INTEGRITY_ISSUE_DETECTED",
  INTEGRITY_ISSUE_ACKNOWLEDGED: "INTEGRITY_ISSUE_ACKNOWLEDGED",
  INTEGRITY_ISSUE_RESOLVED:    "INTEGRITY_ISSUE_RESOLVED",
  INTEGRITY_ISSUE_SUPPRESSED:  "INTEGRITY_ISSUE_SUPPRESSED",
  // Billing job
  BILLING_INVOICE_GENERATED:   "BILLING_INVOICE_GENERATED",
} as const;
export type FinancialAuditEventType =
  (typeof FinancialAuditEventType)[keyof typeof FinancialAuditEventType];
