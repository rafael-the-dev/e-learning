...
import { getTeacherColumns } from "@/modules/teachers/components/teacher-columns";
import {
...
export function TeachersTable({
  ...
  const [suspendTarget, setSuspendTarget] = React.useState<Teacher | null>(null);
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap gap-3">
        <Input
          className="max-w-xs"
          placeholder="Pesquisar por nome, e-mail, licença..."
          value={search}
        ...
        <EmptyState
          ...
          description={
            defaultSearch || defaultStatus || defaultBranchId
              ...
              : "Adicione o primeiro professor à organização."
          }
        />
      ) : (
        <DataTable
      ...
      <ConfirmDialog
        ...
        description={`Tem a certeza que pretende suspender "${suspendTarget?.fullName}"? O professor ficará sem acesso a novas turmas.`}
