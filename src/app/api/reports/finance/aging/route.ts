...
import { getAgingReport } from "@/modules/reports/finance/services/financial-reports.service";
...
export async function GET(req: NextRequest) {
  try {
    ...
    const report = await getAgingReport(filters);

    await auditService.log(context, {
      entity: "FinancialReport",
      entityId: "aging",
      action: "financial_report.viewed",
      newValues: { reportType: "aging", filters: { branchId: filters.branchId, page, pageSize } },
    });
