...
// GET /api/examinations/lookups/level-subjects?q= — level-subject picker source (exams.view).
export async function GET(req: Request): Promise<NextResponse> {
  ...
  try {
    ...
    return NextResponse.json({ items: await examLookupAdminReadService.levelSubjects(context, q) });
  } catch (err) {
