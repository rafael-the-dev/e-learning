...
// GET /api/examinations/lookups/students?q= — student picker source (exams.view).
export async function GET(req: Request): Promise<NextResponse> {
  ...
  try {
    ...
    return NextResponse.json({ items: await examLookupAdminReadService.students(context, q) });
  } catch (err) {
