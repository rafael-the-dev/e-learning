...
// GET /api/examinations/sessions/:id/publication-readiness (exams.view).
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(await examPublicationAdminReadService.getReadiness(context, id));
  } catch (err) {
